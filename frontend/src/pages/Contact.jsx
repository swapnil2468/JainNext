...
const Contact = () => {
  ...
  return (
    <div className='min-h-screen'>
      ...
      <div className='relative pt-20 pb-20 px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-rose-50/60 via-rose-50/20 to-orange-50/30 min-h-screen flex items-center justify-center'>
