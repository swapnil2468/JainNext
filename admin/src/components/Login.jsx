        ...
        <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
            ...
            <form onSubmit={onSubmitHandler}>
                ...
                <button 
                    type="submit"
                    disabled={loading}
                    className='mt-2 w-full py-2 px-4 rounded-md text-white bg-black disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2'
                >
                    {loading ? (
                        <>
