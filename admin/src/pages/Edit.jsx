        ...
        <div className='lg:col-span-2 space-y-8'>
          ...
          <div className='bg-white rounded-2xl p-6'>
            ...
            <div className='mb-4'>
              ...
              <input onChange={(e) => { setSku(e.target.value); setIsDirty(true) }} value={sku} className='w-full px-4 py-3 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500' type="text" placeholder='e.g. SKU-12345' />
            </div>
            ...
            <div className='mb-4'>
              ...
              {activeTab === 'use-cases' && (
                <div>
                  ...
                  <textarea
                    id='useCasesTextarea'
                    onChange={(e) => { setUseCases(e.target.value); setIsDirty(true) }}
                    value={useCases}
                    className='w-full px-4 py-3 border border-gray-300 rounded-lg h-32 focus:outline-none focus:ring-2 focus:ring-red-500'
